...
Config::Config(std::string config_file) {
    ...
    restricted_call[CPP_LANG] =
    restricted_call[CPP11_LANG] =
    restricted_call[PY2_LANG] =
    restricted_call[PY3_LANG] = {
            SYS__sysctl, SYS_chdir, SYS_chmod, SYS_chown, SYS_chroot, SYS_clone, SYS_creat,
            SYS_create_module, SYS_execve, SYS_fork, SYS_getpgrp, SYS_kill, SYS_mkdir, SYS_mknod,
            SYS_mount, SYS_rmdir, SYS_ptrace, SYS_reboot, SYS_rename, SYS_restart_syscall, SYS_select,
            SYS_setgid, SYS_setitimer, SYS_setgroups, SYS_sethostname, SYS_setrlimit, SYS_setuid, SYS_settimeofday,
            SYS_tkill, SYS_vfork, SYS_vhangup, SYS_vserver, SYS_wait4, SYS_clock_nanosleep, SYS_nanosleep,
            SYS_pause, SYS_accept, SYS_bind, SYS_connect, SYS_listen, SYS_socket

    };

    restricted_call[JAVA_LANG] = {
            SYS__sysctl, SYS_chdir, SYS_chmod, SYS_chown, SYS_chroot, SYS_creat, SYS_create_module,
            SYS_delete_module, SYS_execve, SYS_fork, SYS_getpgrp, SYS_kill, SYS_mkdir, SYS_mknod,
            SYS_mount, SYS_rmdir, SYS_ptrace, SYS_reboot, SYS_rename, SYS_restart_syscall, SYS_select,
            SYS_setgid, SYS_setitimer, SYS_setgroups, SYS_sethostname, SYS_setrlimit, SYS_setuid, SYS_settimeofday,
            SYS_tkill, SYS_vfork, SYS_vhangup, SYS_vserver, SYS_wait4, SYS_clock_nanosleep, SYS_nanosleep,
            SYS_pause, SYS_accept, SYS_bind, SYS_connect, SYS_listen, SYS_socket
    ...
    std::vector<std::string> check_list = {
            "listen_port", "db_ip", "db_port", "db_name", "db_user",
            "db_password", "low_privilege_uid", "compile_time_ms", "stack_limit", "spj_run_time_ms",
            "spj_memory_kb", "source_file", "binary_file", "output_file", "ce_info_file", "temp_path",
            "max_output_limit", "test_files_path", "spj_files_path", "stderr_file", "vm_multiplier", "extra_runtime",
            "connect_string",
    };
